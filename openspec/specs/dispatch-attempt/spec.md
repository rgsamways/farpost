...
## Purpose
The per-candidate dispatch-offer record: who was offered a `Job`, when, and whether they
accepted, declined, or timed out. Deliberately scoped to Farpost's actual current dispatch
model, not ride-share-scale real-time proximity matching.
