...
## Purpose
A record of a field visit to a building. `photo_urls`/`gps_accuracy_m` are genuinely new for
this rebuild — no old-system precedent — grounded instead in Farpost's own field-verified-data
business model.
