...
The mobile-breakpoint header — sticky navy/orange band, brand link, and the sign-in/hamburger/settings icon cluster. Established by `mobile-app-shell` (archived 2026-07-26). Companion to `desktop-app-shell`, which covers the `xl:` breakpoint.
